...
const Chat: React.FC = () => {
  ...
  return (
    <div className="container-app flex flex-col h-screen bg-gradient-to-br from-rose-200 via-blue-200 to-pink-300">
      {/* Header */}
      <header className="px-4 py-2 flex items-center justify-between border-b border-neutral-200 bg-white bg-opacity-70 backdrop-blur-sm">
      ...
      {/* Input Area */}
      <div className="p-4 border-t border-neutral-200 bg-white bg-opacity-70 backdrop-blur-sm">
