...
const MainMenu: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-rose-200 via-blue-200 to-pink-300 min-h-screen">
      <PageTransition>
        <div className="container-app p-8 relative z-10">
          {/* Sidebar menu */}
          <motion.div
          ...
          <div className="h-full flex flex-col items-center justify-center">
            <header className="py-4 absolute top-0 left-0 p-8 z-20">
